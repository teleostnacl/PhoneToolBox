...
import static com.teleostnacl.phonetoolbox.lib.crash.CrashActivity.ARG_CRASH_MESSAGE;
...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    public static String getCrashString() {
        ...
        // 获取应用名和版本号
        stringBuilder
                .append(PmAmUtils.getApplicationLabel())
                .append(" ver.")
                .append(PmAmUtils.getVersionName())
